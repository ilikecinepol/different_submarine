...
def input_window():
    ...
    def calc():
        try:
            ...
            comfortable_different_cisterns[3].set(comfortable_different_cisterns[2].get() - comfortable_different_cisterns[0].get())
            comfortable_different_cisterns[4].set(comfortable_different_cisterns[3].get() * comfortable_different_cisterns[1].get())
    ...
    btn_test1 = Button(tab1, text='Рассчитать', command=calc)
    btn_test2 = Button(tab2, text='Рассчитать', command=calc)
    btn_test1.grid(row=13, column=5)
    btn_test2.grid(row=13, column=5)
