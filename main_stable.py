...
new_different_cisterns= [0, 0, 0, 0, 0]

new_different_cisterns [0] = IntVar()
new_different_cisterns [1] = IntVar()
new_different_cisterns [2] = IntVar()
new_different_cisterns [3] = IntVar()
new_different_cisterns [4] = IntVar()

comfortable_different_cisterns= [0, 0, 0, 0, 0]

comfortable_different_cisterns [0] = IntVar()
comfortable_different_cisterns [1] = IntVar()
comfortable_different_cisterns [2] = IntVar()
comfortable_different_cisterns [3] = IntVar()
comfortable_different_cisterns [4] = IntVar()
...
Itog_vichislenii= [0, 0, 0, 0, 0]

Itog_vichislenii [0] = IntVar()
Itog_vichislenii [1] = IntVar()
Itog_vichislenii [2] = IntVar()
Itog_vichislenii [3] = IntVar()
Itog_vichislenii [4] = IntVar()
...
def input_window():
    ...
    Label(tab2, text="Уравнительная цистерна") \
        .grid(row=3, column=0)
    in11 = Entry(tab2, width=10, textvariable=yravnenie[0])
    in12 = Entry(tab2, width=10, textvariable=yravnenie[1])
    in13 = Entry(tab2, width=10, textvariable=yravnenie[2])
    Entry(tab2, width=10) \
        .grid(row=3, column=3)

    Label(tab2, text="Новые дифферентные цистерны") \
        .grid(row=4, column=0)
    in21 = Entry(tab2, width=10, textvariable=new_different_cisterns[0])
    in22 = Entry(tab2, width=10, textvariable=new_different_cisterns[1])
    in23 = Entry(tab2, width=10, textvariable=new_different_cisterns[2])
    Entry(tab2, width=10) \
        .grid(row=4, column=3)

    Label(tab2, text="Кормовые дифферентные цистерны") \
        .grid(row=5, column=0)
    in31 = Entry(tab2, width=10, textvariable=comfortable_different_cisterns[0])
    in32 = Entry(tab2, width=10, textvariable=comfortable_different_cisterns[1])
    in33 = Entry(tab2, width=10, textvariable=comfortable_different_cisterns[2])
    Entry(tab2, width=10) \
        .grid(row=5, column=3)

    Label(tab2, text="Итого вспомогательного баланса") \
        .grid(row=6, column=0)
    in41 = Entry(tab2, width=10, textvariable=Itog_vichislenii[0])
    in42 = Entry(tab2, width=10, textvariable=Itog_vichislenii[1])
    in43 = Entry(tab2, width=10, textvariable=Itog_vichislenii[2])
    Entry(tab2, width=10) \
        .grid(row=6, column=3)
    ...
    def calc():
        try:
            ...
            yravnenie[0].set(in11.get())
            print(yravnenie[0].get())
            yravnenie[1].set(in12.get())
            print(yravnenie[1].get())
            yravnenie[2].set(in13.get())
            print(yravnenie[2].get())
            yravnenie[3].set(yravnenie[2].get() - yravnenie[0].get())
            yravnenie[4].set(yravnenie[3].get() * yravnenie[1].get())
            text135 = Label(tab2, text=str(yravnenie[3].get()))
            text136 = Label(tab2, text=str(yravnenie[4].get()))

            new_different_cisterns[0].set(in21.get())
            print(new_different_cisterns[0].get())
            new_different_cisterns[1].set(in22.get())
            print(new_different_cisterns[1].get())
            new_different_cisterns[2].set(in23.get())
            print(new_different_cisterns[2].get())
            new_different_cisterns[3].set(new_different_cisterns[2].get() - new_different_cisterns[0].get())
            new_different_cisterns[4].set(new_different_cisterns[3].get() * new_different_cisterns[1].get())
            text235 = Label(tab2, text=str(new_different_cisterns[3].get()))
            text236 = Label(tab2, text=str(new_different_cisterns[4].get()))

            comfortable_different_cisterns[0].set(in31.get())
            print(comfortable_different_cisterns[0].get())
            comfortable_different_cisterns[1].set(in32.get())
            print(comfortable_different_cisterns[1].get())
            comfortable_different_cisterns[2].set(in33.get())
            print(comfortable_different_cisterns[2].get())
            comfortable_different_cisterns[3].set(
                comfortable_different_cisterns[2].get() - comfortable_different_cisterns[0].get())
            comfortable_different_cisterns[4].set(
                comfortable_different_cisterns[3].get() * comfortable_different_cisterns[1].get())
            text335 = Label(tab2, text=str(comfortable_different_cisterns[3].get()))
            text336 = Label(tab2, text=str(comfortable_different_cisterns[4].get()))

            Itog_vichislenii[0].set(in41.get())
            print(Itog_vichislenii[0].get())
            Itog_vichislenii[1].set(in42.get())
            print(Itog_vichislenii[1].get())
            Itog_vichislenii[2].set(in43.get())
            print(Itog_vichislenii[2].get())
            Itog_vichislenii[3].set(Itog_vichislenii[2].get() - Itog_vichislenii[0].get())
            Itog_vichislenii[4].set(Itog_vichislenii[3].get() * Itog_vichislenii[1].get())
            text435 = Label(tab2, text=str(Itog_vichislenii[3].get()))
            text436 = Label(tab2, text=str(Itog_vichislenii[4].get()))
            ...
            #strokavichislenii2
            summ2[0].set(
                yravnenie[0].get() + new_different_cisterns[0].get() + comfortable_different_cisterns[0].get() + Itog_vichislenii[0].get())
            summ2[2].set(
                yravnenie[2].get() + new_different_cisterns[2].get() + comfortable_different_cisterns[2].get() + Itog_vichislenii[2].get())
            summ2[3].set(
                yravnenie[3].get() + new_different_cisterns[3].get() + comfortable_different_cisterns[3].get() + Itog_vichislenii[3].get())
            summ2[4].set(
                yravnenie[4].get() + new_different_cisterns[4].get() + comfortable_different_cisterns[4].get() + Itog_vichislenii[4].get())

            text_summ15 = Label(tab2, text=str(summ2[0].get()))
            text_summ16 = Label(tab2, text=str(summ2[2].get()))
            if float(summ2[3].get()) != 0:
                text_summ17 = Label(tab2, text=str(summ2[3].get()), fg='red')
            else:
                text_summ17 = Label(tab2, text=str(summ2[3].get()), fg='green')
            text_summ18 = Label(tab2, text=str(summ2[4].get()))
            ...
            text135.grid(row=3, column=5)
            text136.grid(row=3, column=6)
            text235.grid(row=4, column=5)
            text236.grid(row=4, column=6)
            text335.grid(row=5, column=5)
            text336.grid(row=5, column=6)
            text435.grid(row=6, column=5)
            text436.grid(row=6, column=6)
            '''
            ...
            text_summ15.grid(row=7, column=1)
            text_summ16.grid(row=7, column=4)
            text_summ17.grid(row=7, column=5)
            text_summ18.grid(row=7, column=6)
    ...
    in11.grid(row=3, column=1)
    in12.grid(row=3, column=2)
    in13.grid(row=3, column=4)
    in21.grid(row=4, column=1)
    in22.grid(row=4, column=2)
    in23.grid(row=4, column=4)
    in31.grid(row=5, column=1)
    in32.grid(row=5, column=2)
    in33.grid(row=5, column=4)
    in41.grid(row=6, column=1)
    in42.grid(row=6, column=2)
    in43.grid(row=6, column=4)
...
btn3 = Button(tk, text="Ввод данных для рассчёта", command=input_window).place(x=500, y=200)
# entry.pack()
...
class Submarine:
    ...
    def rotate(self):
        #self.rotate_pict = [f"pictures/different_deg/{x}.gif" for x in range(-44, 44)]
        self.a1 = PhotoImage(file="pictures/different_deg/-44.gif")
        self.a2 = PhotoImage(file="pictures/different_deg/-43.gif")
        self.a3 = PhotoImage(file="pictures/different_deg/-42.gif")
        self.a4= PhotoImage(file="pictures/different_deg/-41.gif")
        self.a5 = PhotoImage(file="pictures/different_deg/-40.gif")
        self.a6 = PhotoImage(file="pictures/different_deg/-39.gif")
        self.a7 = PhotoImage(file="pictures/different_deg/-38.gif")
        self.a8 = PhotoImage(file="pictures/different_deg/-37.gif")
        self.a9 = PhotoImage(file="pictures/different_deg/-36.gif")
        self.a10 = PhotoImage(file="pictures/different_deg/-35.gif")
        self.a11 = PhotoImage(file="pictures/different_deg/-34.gif")
        self.a12 = PhotoImage(file="pictures/different_deg/-33.gif")

        self.canvas.itemconfig(self.id, image=self.a1)
        pos = self.canvas.coords(self.id)
        for x in range(89):
            canvas.create_image(self.start[0], self.start[1], image=self.d555)

s = Submarine()
s.rotate()
btn1 = Button(tk, text="Всплытие!", command=s.emersion, width=15).place(x=1050, y=200)
btn2 = Button(tk, text="Погружение!", command=s.diving, width=15).place(x=1050, y=300)
